...
dfBrasilNorte = dfBrasil[dfBrasil['região'] == 'Norte']

X_detrator = dfBrasilNorte[colunas_grupo_4]

y_detrator = dfBrasilNorte['nps'].map({'detrator': 1, 'neutro': 0, 'promotor': 0})
...
X_neutro = dfBrasilNorte[colunas_grupo_4]

y_neutro = dfBrasilNorte['nps'].map({'detrator': 0, 'neutro': 1, 'promotor': 0})
