...
dfBrasilNordeste = dfBrasil[dfBrasil['região'] == 'Nordeste']

X_detrator = dfBrasilNordeste[colunas_grupo_4]

y_detrator = dfBrasilNordeste['nps'].map({'detrator': 1, 'neutro': 0, 'promotor': 0})
...
X_neutro = dfBrasilNordeste[colunas_grupo_4]

y_neutro = dfBrasilNordeste['nps'].map({'detrator': 0, 'neutro': 1, 'promotor': 0})
